...
public class GameBD_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Excel/GameBD.xlsx";
	private static readonly string exportPath = "Assets/Excel/GameBD.asset";
